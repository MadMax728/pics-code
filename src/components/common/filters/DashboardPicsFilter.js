...
class DashboardPicsFilter extends Component {
  constructor(props) {
    super(props);
    this.state = {
      filterApply: false,
  ...
  render() {
    ...
    const userGroupItems = [
      {
        name: Translations.user_group.all_users,
        className: "radio-btn lbl-margin",
        checked: true,
        value: Translations.user_group.all_users
      },
      {
        name: Translations.user_group.subscribed,
        className: "radio-btn ",
        checked: false,
        value: Translations.user_group.subscribed
      }
    ];
    ...
    const Filters = [
      ...
      // },
      {
        ...
        className: "filter-title",
        type: Translations.left_sidebar_filter.user_group.type,
