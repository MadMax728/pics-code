      ...
      <div className="feed_wrapper">
        <div className="feed_header">
          <div className="col-sm-1 col-xs-1 no-padding profile_image">
            <img
              src={video_detail.user.image}
              alt="image1"
              className="img-circle img-responsive"
            />
          </div>
          <div className="col-sm-9 col-xs-7 no-padding">
            <div className="normal_title">{video_detail.user.name}</div>
            <div className="grey_title">Sponsored in Category</div>
            <div className="grey_title">{video_detail.category}</div>
          </div>
        ...
        <div className="feed_footer padding-15">
          <div className="messages">
            <span className="count">{video_detail.msg_count}</span>
            <img src={images.feed_msg} alt={"feed_msg"} />
          </div>
          <div className="likes">
            <span className="count">{video_detail.like_count}</span>
        ...
        <div className="status backoffice-status">
          <div className="status-wrapper">
            ...
            <div className="subtitle">{video_detail.date}</div>
          </div>
          <div className="status-wrapper">
            <div className="title">Reports</div>
            <div className="subtitle">{video_detail.reports}</div>
          </div>
          <div className="status-wrapper">
            <div className="title">Status</div>
            <div className="subtitle">{video_detail.status}</div>
          </div>
        </div>
      </div>
    </div>
