...
class DataProtectionAndPrivacyPolicy extends Component {
  componentDidMount = () => {
    window.scrollTo(0, 0);
  };
        ...
        <div className="cms-middle-section col-xs-12">
          <div className="panel-wrapper wid100">
            <div className="content-wrapper padding-rl-23">
              <div className="title">Data Protection and Privacy Policy</div>
              <p>
...
export default connect(mapStateToProps)(DataProtectionAndPrivacyPolicy);
