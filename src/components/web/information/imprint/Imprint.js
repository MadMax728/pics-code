      ...
      <div className="cms-middle-section">
        <div className="panel-wrapper">
          <div className="col-sm-6 content-wrapper">
            ...
            <div className="contact-wrapper">
              <div>
                Phone DE: <a href="tel:+49 151 12706187">+49 151 12706187</a>
              </div>
              <div>
                E-Mail:{" "}
            ...
            <div className="contact-wrapper">Handelsregister HRB: 0000</div>
            <div className="contact-wrapper">
              Geschäftsführer: Marc Aurel Bopp
            </div>
            <div className="contact-wrapper">UST ID: DE 000000</div>
          </div>
