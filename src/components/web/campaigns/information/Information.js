      ...
      <div className="information-wrapper">
        <div className="info-inner-wrapper">
          ...
          <div className="text">
            ...
            example.This text is an example.This text is an example.This text is
            an example.This text is an example.This text is an example.This text
            is an example.This text is an example.This text is an example.
          </div>
          ...
          <div className="feed-comment">
            <div className="comment-wrapper">
              ...
              <div className="col-sm-2 col-xs-2 emoji_wrapper pull-right">
                <img src={images.emoji} alt="like-2" className="pull-right" />
              </div>
            </div>
            <div className="comment-wrapper">
