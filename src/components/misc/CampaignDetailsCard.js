        ...
        <div className="feed_wrapper">
          <div className="feed_header">
            ...
            <div className="col-sm-9 col-xs-7">
              ...
              <div className="secondary_title">{campaignDetails.userName}</div>
            ...
            <div className="feed_description col-xs-12">
              <div className="col-sm-6 no-padding">
                <div className="info_wrapper">
                  ...
                  <span className="secondary_title">
                    {moment(campaignDetails.startDate).format("MMMM Do YYYY")}
                  </span>
                </div>
                <div className="info_wrapper">
              ...
              <div className="col-sm-6 no-padding">
                <div className="info_wrapper">
                  ...
                  <span className="secondary_title">
                    {moment(campaignDetails.endDate).format("MMMM Do YYYY")}
                  </span>
                </div>
                <div className="info_wrapper">
