import { api } from "../api";
import {
  setSavedPostEndPoint,
  getAboutEndPoint,
  getSavedOwnerEndPoint,
  getNewsFeedOtherEndPoint,
  getNewsFeedOwnerEndPoint
...
// Get Saved API
export const getSavedOwner = (payload, header = {}) =>
  api(baseUrl, header).get(getSavedOwnerEndPoint);
